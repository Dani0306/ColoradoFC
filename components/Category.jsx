...
const Category = ({ items, activeIndex }) => {
  return (
        <div className='w-full h-full flex items-center justify-center'>
            <motion.div variants={staggerContainer} initial="hidden" whileInView="show" viewport={{ once: false, amount: 0.25 }} className="relative bg-[url('/formacion.jpeg')] bg-cover bg-center w-full h-[350px] lg:w-[900px] lg:h-[500px] items-center justify-start lg:justify-center flex flex-col rounded-xl mt-[80px] pt-[50px] lg:pt-auto">
